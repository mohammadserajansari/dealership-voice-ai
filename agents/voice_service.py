...
# from database.database import log_booking
...
#     payload = {"text": text}
#     params = {"model": "aura-luna-en", "encoding": "linear16", "container": "wav", "sample_rate": 16000}
...
#     return clean_speech(str(result.raw))
